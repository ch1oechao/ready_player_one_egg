...
void setupI2SMic() {
  ...
  esp_log_level_set("I2S", ESP_LOG_DEBUG); // Disable I2S logging

  ESP_LOGI("I2S", "Installing I2S setup...");

  // Cleanup any existing I2S driver
  ...
  ESP_LOGI("I2S", "I2S driver installed successfully");

  err = i2s_set_pin(I2S_NUM_0, &pin_config);
  if (err != ESP_OK) {
    ESP_LOGE("I2S", "Failed to set I2S pins: %s", esp_err_to_name(err));
    return;
  }
  ESP_LOGI("I2S", "I2S pins setup successfully");
  i2s_zero_dma_buffer(I2S_NUM_0);
  ESP_LOGI("I2S", "I2S microphone setup complete");
}
